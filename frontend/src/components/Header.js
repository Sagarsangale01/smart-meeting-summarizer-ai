  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
        ...
        <Box>
          <Typography sx={{ fontWeight: 800, fontSize: '1rem', color: '#f1f5f9', letterSpacing: '-0.3px', lineHeight: 1.2 }}>MeetingMind</Typography>
          <Typography sx={{ color: '#6366f1', fontWeight: 500, fontSize: '0.68rem', letterSpacing: '0.5px' }}>AI-Powered Summariser</Typography>
        </Box>
      </Box>
        ...
        <Tooltip title='Sagar Sangale'>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            <Box sx={{ textAlign: 'right', display: { xs: 'none', lg: 'block' } }}>
              <Typography sx={{ fontSize: '0.78rem', fontWeight: 700, color: '#f1f5f9', lineHeight: 1 }}>Sagar Sangale</Typography>
              <Typography sx={{ fontSize: '0.65rem', color: '#64748b', mt: 0.3 }}>Technical Candidate</Typography>
            </Box>
            <Avatar
              sx={{
                width: 32,
